...
coursesDiv.classList.add('allCourses');
...
for (const coursesArrayElement of coursesArray) {
    ...
    title.append(`title: ${coursesArrayElement.title}`);
    let monthDuration = document.createElement('div');
    monthDuration.append(`monthDuration: ${coursesArrayElement.monthDuration}`);
    monthDuration.classList.add('monthDuration');
    let hourDuration = document.createElement('div');
    hourDuration.append(`hourDuration: ${coursesArrayElement.hourDuration}`);
    hourDuration.classList.add('hourDuration');
    let monthHourDuration = document.createElement('div');
    monthHourDuration.classList.add('monthHourDuration');
    monthHourDuration.appendChild(hourDuration);
    monthHourDuration.appendChild(monthDuration);
    elDiv.append(title, monthHourDuration);
